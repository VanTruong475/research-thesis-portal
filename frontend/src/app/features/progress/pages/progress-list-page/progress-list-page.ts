...
@Component({
  ...
  template: `
    <div class="max-w-4xl mx-auto">
      <div class="mb-8">
        <h1 class="text-3xl font-display font-bold text-champagne mb-2">Tiến độ Hướng dẫn</h1>
      ...
      <div class="mt-12">
        <h2 class="text-xl font-display font-medium text-champagne mb-6">Lịch sử Báo cáo</h2>
